...
import alphaVantage.input.timeseries.Interval;
import alphaVantage.input.timeseries.OutputSize;
import alphaVantage.output.JsonParser;
import alphaVantage.output.timeseries.*;
...
public class TimeSeriesInput {
	...
	/**
	 * Constructs a Time Series Data api endpoint with the help of an
	 * {@link ApiConnector} and a {@link JsonParser}
	 *
	 * @param apiConnector
	 *            the connection to the api
	 */
	public TimeSeriesInput(ApiConnector apiConnector) {
	 ...
	 * @param interval
	 *            the interval between two consecutive data points in the time
	 *            series {@link Interval}
	 * @param outputSize
	 *            the specification of the amount of returned data points
	 *            {@link OutputSize}
